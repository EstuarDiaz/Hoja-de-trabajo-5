...
for interval in (10,5,1):
    ...
    graficar(("Promedio de tiempos por numero de procesos (intervalo de llegada: %d)" % interval)
        ,listadoNumeroProcesos,tiempoPorProcesos)
    graficar(("Desviacion estandar de tiempos por numero de procesos (intervalo de llegada: %d)" % interval)
